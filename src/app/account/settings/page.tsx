  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2]">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-2xl p-6 border border-[#E8DFF5]/60 mb-5">
          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div>
              ...
              <input value={session?.user?.email ?? ""} disabled
                className="w-full px-4 py-3 rounded-xl border border-[#D4C5B0] bg-[#E8DFF5]/20 text-sm font-inter font-light text-[#8B8B8B] cursor-not-allowed" />
        ...
        <div className="bg-white rounded-2xl p-6 border border-[#E8DFF5]/60">
          <h2 className="font-playfair font-semibold text-[#4A2C5A] text-xl mb-2"
