            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-6">
              {addresses.map((addr) => (
                <div key={addr.id} className="bg-white rounded-2xl p-5 border border-[#E8DFF5]/60 relative">
                  ...
                  <p className="text-sm font-inter font-normal text-[#2A2A2A] mb-1">{addr.fullName}</p>
                  <p className="text-sm font-inter font-light text-[#8B8B8B]">{addr.streetAddress}</p>
                  {addr.addressLine2 && <p className="text-sm font-inter font-light text-[#8B8B8B]">{addr.addressLine2}</p>}
                  <p className="text-sm font-inter font-light text-[#8B8B8B]">{addr.city}, {addr.province} {addr.postalCode}</p>
                  <p className="text-sm font-inter font-light text-[#8B8B8B]">{addr.country}</p>
