  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] flex items-center justify-center px-4 py-20">
      <div className="max-w-lg w-full text-center">
        ...
        <h1 className="font-playfair font-semibold text-[#1A1410] text-3xl mb-3"
        ...
        <div className="bg-white rounded-2xl p-6 border border-[#F7F3EE] mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/account/orders"
            className="px-6 py-3 bg-[#1A1410] text-white font-inter font-normal text-sm rounded-xl hover:bg-[#5B3A6B] transition-colors">
            View My Orders
          </Link>
          <Link href="/shop"
            className="px-6 py-3 border border-[#1A1410] text-[#1A1410] font-inter font-light text-sm rounded-xl hover:bg-[#F7F3EE]/50 transition-colors">
            Continue Shopping
          </Link>
        </div>
      </div>
