        ...
        html: `
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#2A2A2A">
            ...
            <div style="padding:32px;text-align:center">
              <h2 style="color:#1A1410;font-family:Georgia,serif">Welcome to the Khwab family!</h2>
              <p>Thank you for subscribing. Here's your exclusive discount code:</p>
              <div style="background:#FAF7F2;border:2px dashed #C4992E;border-radius:12px;padding:20px;margin:24px 0;font-size:24px;letter-spacing:0.2em;color:#1A1410;font-weight:600">
                WELCOME10
              </div>
              ...
              <a href="${process.env.NEXTAUTH_URL}/shop"
                style="display:inline-block;margin-top:16px;padding:14px 32px;background:#1A1410;color:white;border-radius:8px;text-decoration:none;font-size:14px">
                Shop Now
              </a>
            </div>
          </div>
