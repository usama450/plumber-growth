  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2]">
      ...
      <div className="relative h-64 sm:h-80 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#4A2C5A]/60" />
        <div className="absolute inset-0 flex items-center justify-center text-center px-4">
          <div>
            <h1 className="font-playfair font-semibold text-white text-4xl mb-3"
              style={{ fontFamily: "var(--font-playfair)" }}>Our Story</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-16">
          <div id="story" className="grid sm:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2 className="font-playfair font-semibold text-[#4A2C5A] text-2xl mb-4"
                style={{ fontFamily: "var(--font-playfair)" }}>From Pakistan to Canada, with love</h2>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="bg-white rounded-2xl p-6 border border-[#E8DFF5]/60 text-center">
                <span className="text-3xl mb-3 block">{item.icon}</span>
                <h3 className="font-playfair font-semibold text-[#4A2C5A] text-lg mb-2"
                  style={{ fontFamily: "var(--font-playfair)" }}>{item.title}</h3>
        ...
        <div className="mt-12 text-center">
          <Link href="/shop"
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#4A2C5A] text-white font-inter font-normal text-sm rounded-xl hover:bg-[#5B3A6B] transition-colors">
            Shop Our Collection →
          </Link>
        </div>
      </div>
