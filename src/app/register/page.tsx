      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 border border-[#E8DFF5]/60 shadow-[0_4px_24px_rgba(74,44,90,0.08)]">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8B8B8B] hover:text-[#4A2C5A]">
          ...
          <button onClick={() => signIn("google", { callbackUrl: "/account" })}
            className="w-full mt-3 flex items-center justify-center gap-3 py-3 border border-[#D4C5B0] rounded-xl text-sm font-inter font-light text-[#2A2A2A] hover:bg-[#E8DFF5]/30 transition-colors">
        ...
        <p className="text-center text-sm font-inter font-light text-[#8B8B8B] mt-6">
          ...
          <Link href="/login" className="text-[#4A2C5A] hover:underline">Sign in →</Link>
        </p>
      </div>
    </div>
  );
